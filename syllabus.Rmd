...
### Online Logistics
Because we are now doing this course online, you will be responsible for attending or watching a recording of our weekly webinar. This webinar will be conducted on Zoom at 7pm each Wednesday starting on March 25th. Please log in to the meeting using the following information.

https://utah.zoom.us/j/902586946  
...
schedule <- tribble(
    ~Date,~Week,~Topic,~Due,
    'March 25',1,'Course logistics <br> Lecture 1: Introduction to Data Visualization <br> Lab 1: Introduction to RStudio Cloud and R Markdown','Ch. 1 [15]',
...
',
'Apr 8',3,'Quiz 2 <br> Tableau Demo (Tentative) <br> Lecture 3: Cognitive Load and Clutter <br> Lecture 4: Directing the Audience <br> Lab 3: Introduction to ggplot', 'Quiz 2 <br> Ch. 3 [28]; Ch. 4 [26] <br> Assignment 1 <br> Lab 2 submission',
'April 15', 4,'Quiz 3 <br> Lecture 5: Design Best Practices <br> Lecture 6: Using Stories <br> Lecture 7: Analyzing Design Choices <br> Lab 4: Intermediate ggplot <br> Exam Review','Quiz 3 <br> Ch. 5[24]; Ch. 6 [13]; Ch. 7 [21] <br> Lab 3 submission',
'April 22',5,'Exam <br> (optional) Lab 5: Reports and Dashboards in R/Shiny', 'Lab 4 submission <br> Assignment 2 <br> Exam'
) %>%
