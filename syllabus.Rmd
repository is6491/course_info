...
_Instructor_: Jeremy Morris   
_Office_: Off Campus  
_Email_: (use Canvas direct messages for course-related items; do not use .edu email)  
_Phone_: 801-573-3265  
_Office Hours_: SFEBB 8220D, 4:30-5:30 Tue  
_Twitter_: @seedatarun  

Start Date: March 27, 2019  
Classroom: SFEBB 3180  

This is a draft syllabus and is subject to change as the course start date approaches. Please come back to see changes.
...
',
'Apr 10',3,'Quiz 2 <br> Lecture 3: Cognitive Load and Clutter <br> Lecture 4: Directing the Audience <br> Lab 3: Introduction to ggplot', 'Quiz 2 <br> Ch. 3 [28]; Ch. 4 [26] <br> Assignment 1 <br> Lab 2 submission',
